...
export type WishlistProductPreviewImage = {
  id: string;
  url?: string | null;
};
...
export type WishlistProductPreview = {
  ...
  images?: WishlistProductPreviewImage[] | null;
};

export type WishlistProductVariant = ProductVariantFragment & {
  product?: WishlistProductPreview | null;
};
...
export type WishlistItemGraphQL = {
  ...
  productVariant: WishlistProductVariant | null;
};
